"""Independent tests for the BZ components: parameters, magnetization, injection, birth metric."""
import unittest
import jax
...
class TestBirthMetric(unittest.TestCase):
    ...
    def test_timestep_is_cfl_with_optional_cap(self):
        ...
        _,d2,_,_=build_runtime(replace(p,maximum_timestep=cfl_dt/2))
    ...
    def test_active_axis_sample_is_reported(self):
        ...
        self.assertIn('particle metric',err.get())
